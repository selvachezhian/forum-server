...
class ForumThreadsControllerTest < ActionController::TestCase
  ...
  test "should create forum_thread" do
    assert_difference('ForumThread.count') do
      post :create, forum_thread: { description: @forum_thread.description, forum_id: @forum_thread.forum_id, title: @forum_thread.title }
    end
  ...
  test "should update forum_thread" do
    patch :update, id: @forum_thread, forum_thread: { description: @forum_thread.description, forum_id: @forum_thread.forum_id, title: @forum_thread.title }
    assert_redirected_to forum_thread_path(assigns(:forum_thread))
  end
